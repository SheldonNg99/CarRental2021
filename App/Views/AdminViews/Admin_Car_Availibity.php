  ...
  <body>
    <div id="Main-Section">
      ...
      <div id="Top-Filter-Section" class="TopButtonWrapper">
        <a href="<?= BASEURL;  ?>/Admin/Upload_Availibity"class="text-decoration-none"><button id="Add-New-Car-Button" type="button" name="button">New</button></a>
      </div>
      <div id="Main-Container">
        <div id="Popular-Cars-wrapper">
        <?php foreach($data['Get_All_Availibility'] as $Cars): ?>
          <div class="Horizontal-Cars-Container">
            <div class="Horizontal-Cars-Left">
              ...
              <span class="Horizontal-Cars-Services">
                <ol>
                  <li>Price Per Hour: <?= $Cars['PricePerHour'];?></li>
                  <li>Perice Per Ride: <?= $Cars['PricePerRide'];?></li>
                  <li>Service Type: <?= $Cars['Service_Name'];?></li>
                  <li>Status Of Car: <?= $Cars['Status_Of_Car'];?></li>
                </ol>
              </span>
            </div>
